...
##### PRESUPUESTO (CONTROL)
##### VENTAS
    Pedidos de ventas ==> descargar en excel
    Reportes de ventas ==> descargar en excel
    Facturas x organizacion comercial ==> descargar en excel
    Guardar y recuperar configuracion personalizada.
###### MAESTROS CLIENTES, ARTICULO Y PROVEDORES
Revision de los maestros de forma generica.
###### VISTA 360
    Clientes
    docuemtnos
    Articulos
##### CARTERA
    Composicion saldos
    Reconstruido de composicion de saldos
    reportes de saldos por cliente.
    asientos descuadrados
##### COSTOS
    Proceso de costeo
    Contailizacion de movimientos
    reporte de costoe de mov.
    auditoria pmp
##### INVENTARIOS
    Lista de inventarios en el sistema
    reprote de menu por usuario
    Consultas y descarga de archivos formato excel
##### GASTOS
    Revision de reporte mayor caja detallado
    reporte de asientos contables



### 18/08/2022
    1. Capacitacion IP6, mantenimiento de maestros.
    2. Soporte a Sonia con datos de contabilizacion de nomina. Revision coniguracion.
    3. Revisando tema de ¿donde esta mi pedido?
    4. Se programo reunion para revisar caso de ciclos promocionales de LAFAGE para la contabilizacion automatica.
    5. 
### 19/08/2022
    1. capacitacion Monitores en IP6.
    2. Capacitacion de TRASLADOS en IP6.
    3. Reunion de contabilizaion automatica, caso lafage. Se mostro la forma de generar los centros de costo a Sonia y Ana Maria.
    4. Reunion de Activos fijos. Ver compromisos de entregas de datos. 
### 20/08/2022
    1. Soporte de usuarios == guardia fin de semana.
### 22/08/2022 al 26/08/2022
    Semana de vacaciones.    
### 29/08/2022
    1. Revision de reporte, donde esta mi pedido. Acondicionamiento para la presentacion con gerencia.
    2. Ticket de soporte.
### 30/08/2022
    1. Se revisa incidencia de anulaciones realizadas por una mala aplicacion de  proceso, el cual se subsano utilizando una nueva herramienta.
    2. Revisar bloqueo de programa segundo paso para que si ingresan no puedan continuar si es que viene desde un porograma con parametro.
### 31/08/2022
    1. Creacion de reporte de ventas en BI mas ligero solo dos pestañas y query acelerado.
    2. Soporte en cierre de mes.
    3. Se tuvo problemas con el SIAT a las 23:00 aproximadamente, no se completaron de timbrar 4 facturas.
## SEPTIEMBRE 2022
### 01/09/2022    
    1. Reunion con Edson Montoya, parametizacion de tabla de integracion.
    2. Soporte en reporte.
### 03/09/2022
    1. Guadria de fin de semana.
    3. Se carga presupuesto de Hersil desde sep a dic 2022 para megareporte.
    3. Se tiene inconvenientes para descargar archivos del WL2 desde el viernes 02/09, se escala problema a Edisa.
    4. Se da soporte por cierre de contable del mes.
### 05/09/2022
    1. Se genera ticket de soporte a Edisa sobre programa de recomposicion de saldo cliente.
    2. Genera KPI equipo de arquitecto de software.
    3. Se Prepara y actualiza presentacion gerencia general.
#### 06/09/2022
    1. Revisar los pedidos para que pasen directo segun correo.
    2. Atencion de facturacion desde CBBA a SUCRE.==> 

### 09/09/2022
    1. Se revisa nuevo flujo de BPM para la validacion financiera.
    2. atencion de ticket.
### 12/09/2022
    1. Soporte a ticket
### 13/09/2022
    1. soporte a ticket.
    2. Solicitud de status de proyectos - kpi. se cargo datos de medicos clietnes
    3. Se colabora con lista de valores para medicos.
    4. Reunion de contablizacion de nomina con Sonia y equipo de TH. Se define fechas para entregas:
        Planilla de REINTEGRO formato 14/09/2022
        Planilla de AGUINALDO formato 14/09/2022
        Planilla de AGUINALDO 2 formato 14/09/2022
        Planilla de PRIMNA formato 14/09/2022
        Planilla de QUINQUENIO formato 14/09/2022
        Planilla de FINIQUITO formato 14/09/2022
        Planilla de INDENIZACION formato 14/09/2022
### 14/09/2022 MIERCOLES
    1. Se revisa solicitudes para creacion de usuqrio que estaba retrsadas.  Se crea de ACUADROS nueva analista contable.
    2. 
### 15/09/2022
    1. Se envia asiento contabilizado.
    2. En las direcciones 
    3. Moodulo de entrega de equipos y herramientas..
### 19/09/2022
    1. Capacitacion sobre reportes de Ventas BI y donde esta mi pedido?
    2. Reunion status tareas.
    3. 
### 20/09/2022
    1. Se planifico reunion con compras para el dia jueves 22.
    2. Se planifico reunion con suiphar para moostrar el tema de agegar medico a pedidos.
    3. se crea formulas para generar contabilizacion de nomina mensual.
    4. Se envia para validacion a contabilidad.
    5. Reunion de TI. Punto critico los datos de planillas no compartir.
#### 21/09/2022 
